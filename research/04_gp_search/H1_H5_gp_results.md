...
| 0.4×H1_neg_r1h + 0.6×H1_neg_c1 | 0.4 | +0.039* | +0.157 | +0.050 | +7.80 |
| 0.1×H1_neg_r2h + 0.9×H1_neg_c1 | 0.1 | +0.039* | +0.156 | +0.047 | +7.24 |
...
*IC signal search chart: see `research/charts/04_gp_search/ic_signal_search.png`*
